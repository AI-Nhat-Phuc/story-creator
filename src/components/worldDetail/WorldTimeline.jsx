      ...
      {sortedStories.map((story, groupIndex) => {
        ...
        return (
          ...
          >
            ...
            {/* Stretch the marker cell to fill the grid row's height (which
                equals the card height) and centre the SVG inside. The
                `!self-stretch` important modifier defeats DaisyUI's default
                `align-self: start` on .timeline-middle. */}
