...
export default function LoginPage() {
  ...
  const handleGoogleLogin = useGoogleLogin({
    ...
    onError: () => {
      setOauthLoading('')
      setError(t('pages.login.googleFailed'))
    },
  })
          ...
          <div className="card-body">
              ...
              >
                {oauthLoading === 'google' ? (
                  ...
                  <>
                    ...
                    <span>{t('pages.login.loginBtn')}</span>
                  </>
                )}
              </button>
            </div>
            ...
            <form onSubmit={handleSubmit}>
              <div className="form-control">
                <label className="label" htmlFor="username">
                  <span className="font-medium label-text">{t('pages.login.username')}</span>
                </label>
                <input
                  type="text"
                  name="username"
              ...
              <div className="mt-4 form-control">
                <label className="label" htmlFor="password">
                  <span className="font-medium label-text">{t('pages.login.password')}</span>
                </label>
                <input
                  type="password"
                  name="password"
              ...
              <div className="mt-6 form-control">
                ...
                >
                  {loading ? <LoadingSpinner size="sm" /> : t('pages.login.loginBtn')}
                </button>
              </div>
            </form>
            ...
            <div className="text-center">
              <p className="text-sm">
                ...
                <Link to="/register" className="font-semibold link link-primary">
