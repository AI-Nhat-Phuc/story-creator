...
/**
 * GPT Button Component - Special button for GPT/AI functions
 *
 * @param {Object} props
 ...
 * @param {string} props.variant - Button variant: 'primary' | 'secondary' | 'warning' | 'ghost'
  ...
  return (
    ...
    >
      {loading ? (
        ...
        <>
          <OpenAILogo className={size === 'xs' ? 'w-3 h-3' : 'w-4 h-4'} />
          {children}
        </>
      )}
    </button>
...
// Export both the button and the logo for standalone use
export { OpenAILogo }
