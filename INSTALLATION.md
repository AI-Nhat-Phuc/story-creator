...
6. [Tính năng GPT-4](#tính-năng-gpt-4)
...
### Cấu hình cơ bản (Không cần GPT-4)

Không cần cấu hình gì thêm. Có thể sử dụng ngay!

### Cấu hình GPT-4 (Tùy chọn)
...
Nhân vật không điều khiển sẽ có GPT-4 quyết định dựa trên:
- Tính cách nhân vật
